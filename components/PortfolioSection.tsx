...
const projects = [
  ...
  },
  {
    ...
    tech: ["React", "Node.js", "MongoDB", "Chart.js","TypeScript","TailwindCSS"],
  ...
  },
  {
    ...
    desc: "Rimsha Lab Admin is the administrative dashboard for managing operations, tests, and patient records at Rimsha Lab.",
    tech: ["Next.js", "Node.js", "MongoDB", "TypeScript","TailwindCSS"],
    image: "/rimshalabadmin.png",
    link: "https://rimsha-lab-admin.vercel.app/login",
  },
  {
    title: "Prescripto Admin",
    desc: "Prescripto Admin is the backend dashboard for managing prescriptions, users, and health data on the Prescripto platform.",
    tech: ["React", "MongoDB", "Node.js", "Express","TailwindCSS"],
